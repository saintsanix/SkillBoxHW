...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        jsonWriter.writeInJSONFile(metro.getMetroObject(), "C:/Users/sanix/IdeaProjects/java_basics/FilesAndNetwork/DataCollector/src/main/resources/metro.json");
        JSONReader jsonReader = new JSONReader();
        jsonReader.getAmountOfStations("C:/Users/sanix/IdeaProjects/java_basics/FilesAndNetwork/DataCollector/src/main/resources/metro.json");

        DataCollector collector = new DataCollector();
        collector.fileReader("C:/Users/sanix/IdeaProjects/java_basics/FilesAndNetwork/DataCollector/src/main/resources/data");
        ...
        jsonWriter1.writeInJSONFile(stationObject, "C:/Users/sanix/IdeaProjects/java_basics/FilesAndNetwork/DataCollector/src/main/resources/stations.json");
    }
